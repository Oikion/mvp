...
const ENTITY_CONFIGS: EntityConfig[] = [
  {
    ...
    foreignKeys: [
      ...
      { table: "CalendarEvent", column: "assignedUserId" },
  ...
  },
  {
    ...
    foreignKeys: [
      ...
      { table: "crm_Accounts_Tasks", column: "calendarEventId" },
      // Many-to-many through junction tables
    ],
  },
  {
...
async function updateJunctionTables(): Promise<void> {
  ...
  const junctionTables = [
    ...
    { table: "_DocumentsToCalendarEvents", columns: ["A", "B"], entityA: "Documents", entityB: "CalendarEvent" },
    { table: "_DocumentsToTasksExplicit", columns: ["A", "B"], entityA: "Documents", entityB: "crm_Accounts_Tasks" },
    { table: "_EventToClients", columns: ["A", "B"], entityA: "CalendarEvent", entityB: "Clients" },
    { table: "_EventToProperties", columns: ["A", "B"], entityA: "CalendarEvent", entityB: "Properties" },
