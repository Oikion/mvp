...
/**
 * Contact CSV Import Schema
 * Matches the fields from NewAccountForm.tsx and the Prisma Contacts model
 */
export const contactImportSchema = z.object({
  ...
  contact_type: ContactCategoryEnum.optional().nullable(),
  contact_status: ContactStatusEnum.optional().nullable(),
 ...
 */
export const contactImportFieldDefinitions: readonly ContactFieldDefinition[] = [
  ...
  { 
    ...
    description: "Unique identifier for the contact (auto-generated if not provided)"
  },
  ...
  // Required
  {
    ...
    required: true,
    group: "basic",
    aliases: ["name", "full_name", "customer_name", "client_name", "account_name", "onoma", "onomateponimo", "Όνομα", "Επώνυμο", "Ονοματεπώνυμο", "Πελάτης"],
  ...
  },
  {
    ...
    required: false,
    group: "classification",
    aliases: ["client_status", "status", "customer_status", "account_status", "katastasi"],
    description: "Contact status (LEAD, ACTIVE, INACTIVE, etc.)"
  },
  { 
    key: "person_type", 
    required: false, 
  ...
  // Visibility
  {
    ...
    description: "Contact visibility (HIDDEN, PRIVATE, SECURE, PUBLIC)",
  },
] as const;

export type ContactImportFieldKey = (typeof contactImportFieldDefinitions)[number]["key"];
