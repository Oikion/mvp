...
// =============================================================================
// Form Schemas — shared by NewPropertyWizard and EditPropertyForm
// =============================================================================

/**
 * Single source of truth for property form field constraints.
 *
 * Uses z.coerce for numeric inputs (HTML forms return strings).
 * All fields optional at schema level — wizards enforce required fields via
 * step-level form.trigger(); edit forms must not block saving when a field
 * was never populated (e.g. assigned_to: null in the DB).
 *
 * Import this in BOTH NewPropertyWizard and EditPropertyForm.
