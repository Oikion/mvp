...
/**
 * Dialog Component - Oikion Design System
 * 
 * Enhanced dialog with:
 * - Theme-aware backgrounds (surface-2 or surface-3)
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-background/80 backdrop-blur-sm transition-all duration-default ease-in-out",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-semibold text-lg leading-none tracking-tight text-text-primary",
      className
    )}
    {...props}
  />
