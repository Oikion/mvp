...
export function WeekView({
  ...
  useEffect(() => {
    ...
    const targetHour = currentHour >= START_HOUR && currentHour < END_HOUR ? currentHour : 6;
    
    // Scroll to target hour minus 1 hour for context (so target is visible, not at top)
    const scrollToHour = Math.max(START_HOUR, targetHour - 1);
    const scrollPosition = (scrollToHour - START_HOUR) * HOUR_HEIGHT;
  ...
  const getEventPositionForDay = (event: CalendarEvent) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border rounded-lg flex-1 overflow-hidden">
        ...
        {/* Time Grid */}
        <ScrollArea ref={scrollAreaRef} className="h-[calc(100vh-400px)] min-h-[400px]">
              ...
              return (
                ...
                >
                  ...
                  {draftStartTime &&
                    ...
                    (() => {
                      const draftPosition = getEventPosition(draftStartTime, draftEndTime, START_HOUR, END_HOUR);
                      ...
                      return (
                        <Card
                          ...
                          style={{
                            ...
                            height: `${draftPosition.height}px`,
                          }}
                          onClick={(e) => {
                            e.stopPropagation();
                            onDraftSelectionClick?.();
                  ...
                  {/* Events */}
                  {dayEvents.map((event) => {
                    const position = getEventPositionForDay(event);
