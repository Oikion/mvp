...
export const SimpleNewsletterForm = ({ formId }: { formId: string }) => {
  ...
  if (isSubscribed) {
    return (
      <div className="max-w-lg mx-auto text-center simple-newsletter-success">
  ...
  return (
    <form
      ...
      className="flex flex-col gap-6 justify-center items-center max-w-lg mx-auto simple-newsletter-form"
    >
      {/* Email Input */}
      <div className="relative w-full simple-newsletter-field">
      ...
      <div className="w-full bg-primary/5 dark:bg-primary/10 border border-primary/20 dark:border-primary/30 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/15 transition-colors duration-200 simple-newsletter-field">
        <Label
      ...
      <div className="flex items-start gap-2.5 sm:gap-3 w-full text-left simple-newsletter-field">
        <Checkbox
      ...
      <Button
        ...
        className="px-8 text-base sm:text-lg py-5 sm:py-6 w-full sm:w-auto simple-newsletter-submit"
      >
        {isLoading ? (
