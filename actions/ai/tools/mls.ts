  ...
  try {
    ...
    return successResponse({
      properties: items.map((property) => ({
        ...
        area: property.internal_area ? Number(property.internal_area) : null,
        address: {
  ...
  try {
    ...
    return successResponse({
      property: {
        ...
        bathrooms: property.bathrooms,
        area: property.internal_area ? Number(property.internal_area) : null,
        plotArea: property.plot_area ? Number(property.plot_area) : null,
        ...
        assignedTo: property.Users_Properties_assigned_toToUsers,
        linkedClients: property.Clients.map((c) => ({
          id: c.id,
          name: c.client_name,
          type: c.client_type,
  ...
  try {
    ...
    const property = await prismadb.properties.create({
      data: {
        ...
        property_status: status || "AVAILABLE",
        price: price || null,
        bedrooms: bedrooms || null,
        bathrooms: bathrooms || null,
        internal_area: area || null,
        address_street: address?.street || null,
        address_city: address?.city || null,
        address_state: address?.state || null,
        address_postal_code: address?.postalCode || null,
        address_country: address?.country || "Greece",
