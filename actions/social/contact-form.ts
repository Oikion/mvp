...
export async function getContactFormSettings(): Promise<ContactFormSettings> {
  ...
  return {
    ...
    fields: (profile.contactFormFields as ContactFormField[]) || DEFAULT_CONTACT_FORM_FIELDS,
  };
}
...
export async function toggleContactForm(enabled: boolean): Promise<{ success: boolean; error?: string }> {
  try {
    ...
    const fields = (profile.contactFormFields as ContactFormField[]) || DEFAULT_CONTACT_FORM_FIELDS;
...
export async function addContactFormField(
  ...
  try {
    ...
    const currentFields = (profile.contactFormFields as ContactFormField[]) || DEFAULT_CONTACT_FORM_FIELDS;
...
export async function removeContactFormField(
  ...
  try {
    ...
    const currentFields = (profile.contactFormFields as ContactFormField[]) || [];
