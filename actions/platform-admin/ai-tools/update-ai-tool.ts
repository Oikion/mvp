...
import { z } from "zod";
import type { AiTool, AiToolEndpointType, Prisma } from "@prisma/client";
...
export async function updateAiTool(input: UpdateAiToolInput): Promise<UpdateAiToolResult> {
  try {
    ...
    // Build update data
    const updateData: Prisma.AiToolUpdateInput = {};
    if (data.name !== undefined) updateData.name = data.name;
    if (data.displayName !== undefined) updateData.displayName = data.displayName;
    if (data.description !== undefined) updateData.description = data.description;
    if (data.category !== undefined) updateData.category = data.category;
    if (data.parameters !== undefined)
      updateData.parameters = data.parameters as Prisma.InputJsonValue;
