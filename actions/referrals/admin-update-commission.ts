...
/**
 * Create a referral code for a user who doesn't have one
 */
export async function adminCreateReferralCode(
  ...
  try {
    ...
    const { createReferralCode } = await import("@/lib/referrals/create-referral-code");
    ...
    await logAdminAction(admin.clerkId, "WARN_USER", userId, {
