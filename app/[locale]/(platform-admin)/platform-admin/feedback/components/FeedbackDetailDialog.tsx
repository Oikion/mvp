          ...
          <Tabs defaultValue="content" className="flex-1 overflow-hidden">
            ...
            <ScrollArea className="flex-1 mt-4">
              ...
              <TabsContent value="content" className="space-y-6 pr-4">
                ...
                <FeedbackChatHistory feedback={feedback} locale={locale} />
              </TabsContent>

              {/* Technical Tab */}
              <TabsContent value="technical" className="space-y-6 pr-4">
              ...
              {/* Screenshot Tab */}
              <TabsContent value="screenshot" className="space-y-4 pr-4">
                {feedback.screenshot ? (
                  <div className="space-y-4">
              ...
              {/* Console Logs Tab */}
              <TabsContent value="consoleLogs" className="space-y-4 pr-4">
