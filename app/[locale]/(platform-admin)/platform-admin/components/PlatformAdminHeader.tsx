  ...
  const navItems = [
    {
      ...
      active: pathname === `/${locale}/platform-admin`,
    },
    {
      href: `/${locale}/platform-admin/users`,
      label: t("nav.users"),
      icon: Users,
      active: pathname.includes("/platform-admin/users"),
    },
    {
      href: `/${locale}/platform-admin/organizations`,
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                  <Avatar className="h-8 w-8">
                    <AvatarImage
                      src={adminUser?.imageUrl || undefined}
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem asChild className="md:hidden">
                  <Link href={`/${locale}/platform-admin`}>
