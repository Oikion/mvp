...
export default async function OnboardingPage({
  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-4 sm:px-6 md:px-8 py-4 md:py-8 bg-gradient-to-b from-background to-muted/20 overflow-y-auto justify-center">
