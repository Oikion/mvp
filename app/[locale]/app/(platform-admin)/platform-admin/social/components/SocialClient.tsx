...
export function SocialClient({
  ...
  const getPlatformBadge = (platform: string) => {
    const colors: Record<string, string> = {
      ...
      TIKTOK: "bg-gray-800/10 text-gray-800 dark:text-gray-200 hover:bg-gray-800/20",
      TWITTER: "bg-[#1DA1F2]/10 text-[#1DA1F2] hover:bg-[#1DA1F2]/20",
      FACEBOOK: "bg-[#1877F2]/10 text-[#1877F2] hover:bg-[#1877F2]/20",
    };

    return (
      <Badge className={colors[platform] || "bg-gray-500/10 text-gray-500"}>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="text-center p-3 bg-muted rounded-lg">
                  <Repeat2 className="h-5 w-5 mx-auto text-green-500 mb-1" />
