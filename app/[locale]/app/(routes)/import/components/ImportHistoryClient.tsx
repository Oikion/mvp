...
const TYPE_CLASSES: Record<string, string> = {
  ...
  CONTACTS: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400",
  ...
  REQUESTS: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400",
