...
export function CreateDealButton({ translations: t }: CreateDealButtonProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.error(t.toast.error, { description: error.response?.data || t.toast.createError, isTranslationKey: false });
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="space-y-2">
              ...
              {connections.length === 0 && (
                <p className="text-xs text-muted-foreground">
                  ...
                  <Link href="/app/connections" className="text-primary hover:underline">
