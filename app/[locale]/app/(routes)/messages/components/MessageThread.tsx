...
export function MessageThread({ channelId, conversationId, credentials, onReply }: MessageThreadProps) {
                      ...
                      >
                        ...
                        {message.threadCount > 0 && (
                          <div className="mt-2 pt-2 border-t border-current/10">
                            <button className="flex items-center gap-1 text-xs opacity-80 hover:opacity-100">
