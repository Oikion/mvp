...
export function AudienceCard({ audience, translations: t }: AudienceCardProps) {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.error(t.toast.error, { description: t.toast.errorDelete, isTranslationKey: false });
    } finally {
      setIsDeleting(false);
  ...
  const handleSync = async () => {
    try {
      ...
      toast.error(t.toast.error, { description: t.toast.errorSync, isTranslationKey: false });
    } finally {
      setIsSyncing(false);
    }
  };
