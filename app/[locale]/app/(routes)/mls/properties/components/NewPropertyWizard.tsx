        ...
        return (
          <div className="space-y-4">
            <FormSelectWithOther<FormValues, "property_type">
              ...
              label={`${t("mls.PropertyForm.fields.propertyType", "Τύπος ακινήτου")} *`}
              placeholder={t("mls.PropertyForm.fields.propertyTypePlaceholder", "Επιλέξτε τύπο")}
              otherLabel={t("mls.PropertyForm.fields.specifyOther", "Προσδιορίστε τύπο")}
              otherPlaceholder={t("mls.PropertyForm.fields.specifyOtherPlaceholder", "Εισάγετε τον τύπο ακινήτου...")}
              disabled={isLoading}
              options={[
                { value: "APARTMENT", label: t("mls.PropertyForm.propertyType.APARTMENT", "Διαμέρισμα") },
                { value: "HOUSE", label: t("mls.PropertyForm.propertyType.HOUSE", "Μονοκατοικία") },
                { value: "MAISONETTE", label: t("mls.PropertyForm.propertyType.MAISONETTE", "Μεζονέτα") },
                { value: "COMMERCIAL", label: t("mls.PropertyForm.propertyType.COMMERCIAL", "Επαγγελματικός χώρος") },
                { value: "WAREHOUSE", label: t("mls.PropertyForm.propertyType.WAREHOUSE", "Αποθήκη") },
                { value: "PARKING", label: t("mls.PropertyForm.propertyType.PARKING", "Parking") },
                { value: "PLOT", label: t("mls.PropertyForm.propertyType.PLOT", "Οικόπεδο") },
                { value: "FARM", label: t("mls.PropertyForm.propertyType.FARM", "Αγροτεμάχιο") },
                { value: "INDUSTRIAL", label: t("mls.PropertyForm.propertyType.INDUSTRIAL", "Βιομηχανικό") },
                { value: "OTHER", label: t("mls.PropertyForm.propertyType.OTHER", "Άλλο") },
              ]}
            />
