...
export function PropertyMatchingClients({ propertyId, locale = "en" }: Props) {
  ...
  const fetchMatches = async () => {
    ...
    try {
      ...
      setError("Failed to load matching clients");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">Matching Clients</CardTitle>
              <CardDescription>
                Potential buyers/renters based on their preferences
              </CardDescription>
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm mt-1">
              Clients with matching preferences will appear here
            </p>
          </div>
        ) : (
          <div className="space-y-3">
