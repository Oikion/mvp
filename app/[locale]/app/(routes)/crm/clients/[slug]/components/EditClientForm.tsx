...
export function EditClientForm({ initialData }: { initialData: EditClientInitialData }) {
  ...
  const form = useForm<ClientEditFormValues>({
    ...
    defaultValues: {
      ...
      client_type: (initialData.client_type as ClientEditFormValues["client_type"]) || undefined,
      client_status: (initialData.client_status as ClientEditFormValues["client_status"]) || undefined,
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input disabled={isLoading} placeholder="john@domain.com" {...field} value={field.value ?? undefined} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
