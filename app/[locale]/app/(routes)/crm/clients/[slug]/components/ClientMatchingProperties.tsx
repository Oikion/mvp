      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">{t("matchingProperties.title")}</CardTitle>
              <CardDescription>
                {t("matchingProperties.description")}
              </CardDescription>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {t("matchingProperties.refresh")}
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href={`/${locale}/app/matchmaking`} className="inline-flex items-center gap-1">
                {t("matchingProperties.viewAll")}
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>{t("matchingProperties.noMatches")}</p>
            <p className="text-sm mt-1">
              {t("matchingProperties.noMatchesHint")}
            </p>
          </div>
        ) : (
          <div className="space-y-3">
