        ...
        return (
          <div className="space-y-4">
            <FormSelectWithOther<FormValues, "purpose">
              ...
              label={t("crm.CrmForm.fields.purpose", "Σκοπός ακινήτου")}
              placeholder={t("crm.CrmForm.fields.purposePlaceholder", "Επιλέξτε σκοπό")}
              otherLabel={t("crm.CrmForm.fields.specifyOther", "Προσδιορίστε σκοπό")}
              otherPlaceholder={t("crm.CrmForm.fields.specifyOtherPlaceholder", "Εισάγετε τον σκοπό...")}
              options={[
                { value: "RESIDENTIAL", label: t("crm.CrmForm.purpose.RESIDENTIAL", "Κατοικία") },
                { value: "COMMERCIAL", label: t("crm.CrmForm.purpose.COMMERCIAL", "Επαγγελματικό") },
                { value: "LAND", label: t("crm.CrmForm.purpose.LAND", "Γη") },
                { value: "PARKING", label: t("crm.CrmForm.purpose.PARKING", "Χώρος Parking") },
                { value: "OTHER", label: t("crm.CrmForm.purpose.OTHER", "Άλλο") },
              ]}
            />
