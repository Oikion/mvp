  ...
  const statsCards = [
    {
      ...
      icon: Users,
      description: "Clients seeking properties",
      color: "text-primary",
    ...
    {
      title: "Clients with Matches",
      value: analytics.clientsWithMatches,
      icon: Target,
      description: `${analytics.totalClients > 0 ? Math.round((analytics.clientsWithMatches / analytics.totalClients) * 100) : 0}% of clients`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of match scores across all client-property pairs
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Match Quality Overview</CardTitle>
                <CardDescription>
                  Breakdown of match quality levels
                </CardDescription>
              </CardHeader>
                    ...
                    <div key={bucket.range} className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-muted-foreground">
                          {bucket.count} matches ({percentage.toFixed(1)}%)
                        </span>
                      </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Clients Need Properties</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground" />
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">High Demand Properties</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground" />
                </div>
              </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Top Client-Property Matches
              </CardTitle>
              <CardDescription>
                Best matching client-property pairs based on preferences and criteria
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Clients Without Good Matches
              </CardTitle>
              <CardDescription>
                These clients have no properties matching their criteria above 50%
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="hot">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Properties with the most matching clients - high demand opportunities
              </CardDescription>
            </CardHeader>
            <CardContent>
