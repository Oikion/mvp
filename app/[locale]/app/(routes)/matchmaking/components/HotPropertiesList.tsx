...
import { Building2, Users, TrendingUp, ArrowRight, MapPin, Euro, Bed } from "lucide-react";
  ...
  if (properties.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        ...
        <p>No hot properties found.</p>
        <p className="text-sm mt-2">Properties with multiple matching clients will appear here.</p>
      </div>
    );
  }
